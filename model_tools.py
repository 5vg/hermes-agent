...
def handle_function_call(
    ...
    Args:
        ...
        conversation_history: Full conversation history (for smart approval context).
    ...
    # Set conversation context for smart approval (for ALL tools)
    from tools.approval import set_conversation_context, reset_conversation_context

    token = None
    if conversation_history:
        token = set_conversation_context(conversation_history)
    ...
    try:
        ...
        # After successful execution, add to command history
        from tools.approval import add_command_to_history

        # Build command string from args
        cmd_str = str(function_args)
        add_command_to_history(cmd_str, function_name, "executed")
